...
public:
     ...
     */
    const char* info() /* const */ /* OpenWatcom C++ 1.9 doesn't support const version of map::find */
    {
        std::string chksum = checksum();
        
        md5map::const_iterator res = m_checksums.find(chksum);
