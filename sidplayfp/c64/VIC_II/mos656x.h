...
protected:
    ...
    virtual void intrrupt (bool state) = 0;
...
/* Templates not supported this way by Open Watcom C++ 1.9
...
#define STARTDMA_0     setBA(!sprites.isDma(0x01));
